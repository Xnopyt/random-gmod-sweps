--This is a slightly tweaked copy of the Davy Crockett exploded entity from M9K Specialties, all credit for this entity to the creators of that addon
ENT.Type = "anim"
...
AddCSLuaFile('nep_nuke_explode.lua')
...
local sndRumble = Sound("weapons/nep_nuke/nepu.wav")
local sndPop = Sound("weapons/pistol/pistol_fire3.wav")


function ENT:Initialize()
if CLIENT then
    killicon.Add( "nep_nuke_explode", "vgui/entities/killicons/nep_nuke_killicon", Color( 255, 255, 255, 255 ) )
end
self.Yield = (GetConVarNumber("nuke_yield") or 100)/100
